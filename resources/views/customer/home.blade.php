    ...
    <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('assets/img/peta-maluku.jpg') }}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="title mx-5 px-5 animated slideInDown">
                            <div class="title-center">
                                <h5 class="text-success">Selamat Datang</h5>
                                <h1 class="display-1 text-warning">Info Pelayaran Maluku</h1>
                            </div>
                        </div>
                        <p class="fs-5 mb-5 animated slideInDown">Kami akan menyajikan Info Pelayaran seputaran Provinsi Maluku <br> seperti Jadwal Kapal dengan Rute-rute yang tersedia secara up to date.</p>
                        {{-- <a href="#!" class="btn btn-outline-primary border-2 py-3 px-5 animated slideInDown">Explore
                            More</a> --}}
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('assets/img/tidar.jpg') }}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="title mx-5 px-5 animated slideInDown">
                            <div class="title-center">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('assets/img/ferryyyy.jpg') }}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="title mx-5 px-5 animated slideInDown">
                            <div class="title-center">
                                <h5 class="text-success">Info Jadwal</h5>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('assets/img/cantika.jpeg') }}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="title mx-5 px-5 animated slideInDown">
                            <div class="title-center">
                                <h5 class="text-success">Info Jadwal</h5>
                                <h1 class="display-1 text-warning">Kapal Cantika Lestari</h1>
                            </div>
                        </div>
                        <p class="fs-5 mb-5 animated slideInDown">Kami akan menyajikan Info Jadwal semua Kapal Cantika <br> dari atau menuju Kota Ambon secara up to date.</p>
                        {{-- <a href="#!" class="btn btn-outline-primary border-2 py-3 px-5 animated slideInDown">Explore
                            More</a> --}}
                    </div>
                </div>
                {{-- <div class="carousel-item">
                    <img class="w-100" src="{{ asset('assets/customer/Poseify/img/carousel-2.jpg') }}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="title mx-5 px-5 animated slideInDown">
                            <div class="title-center">
                                <h5>Welcome</h5>
        ...
        <div class="container py-5">
                ...
                <div class="row g-0 align-items-center">
                    <div class="col-md-5">
                        <div class="service-img p-5 wow fadeInRight" data-wow-delay="0.2s">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets/customer/Poseify/img/service-1.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
                ...
                <div class="row g-0 align-items-center">
                    <div class="col-md-5 order-md-1 text-md-end">
                        <div class="service-img p-5 wow fadeInLeft" data-wow-delay="0.2s">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets/customer/Poseify/img/service-2.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
            ...
            <div class="service-item service-item-left">
                <div class="row g-0 align-items-center">
                    <div class="col-md-5">
                        <div class="service-img p-5 wow fadeInRight" data-wow-delay="0.2s">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets/customer/Poseify/img/service-3.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="service-text px-5 px-md-0 py-md-5 wow fadeInRight" data-wow-delay="0.5s">
            ...
            <div class="service-item service-item-right">
                <div class="row g-0 align-items-center">
                    <div class="col-md-5 order-md-1 text-md-end">
                        <div class="service-img p-5 wow fadeInLeft" data-wow-delay="0.2s">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets/customer/Poseify/img/service-4.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="service-text px-5 px-md-0 py-md-5 text-md-end wow fadeInLeft" data-wow-delay="0.5s">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/customer/Poseify/img/team-1.jpg') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/customer/Poseify/img/team-2.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/customer/Poseify/img/team-3.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/customer/Poseify/img/team-4.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/customer/Poseify/img/team-5.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/customer/Poseify/img/team-6.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/customer/Poseify/img/team-7.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('assets/customer/Poseify/img/team-8.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                <div class="testimonial-item text-center"
                    data-dot="<img class='img-fluid' src='{{ asset('assets/customer/Poseify/img/testimonial-1.jpg') }}' alt=''>">
                ...
                <div class="testimonial-item text-center"
                    data-dot="<img class='img-fluid' src='{{ asset('assets/customer/Poseify/img/testimonial-2.jpg') }}' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed
                        sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum
                        justo sea clita.</p>
                ...
                <div class="testimonial-item text-center"
                    data-dot="<img class='img-fluid' src='{{ asset('assets/customer/Poseify/img/testimonial-3.jpg') }}' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed
                        sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum
                        justo sea clita.</p>
